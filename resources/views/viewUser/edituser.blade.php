	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				Edit User<a href="{{ url('/view-users') }}" class="col-2 pull-right" style="text-decoration: none;"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
			</div>
							...
							<form role="form" id="sev" action="{{ url('/view-users/'.$users->id) }}" method="POST" class="form-horizontal">
                                ...
                                <div class="col-lg-12 center-block">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" name="pnumber"  value="{{ isset($users->phone_number) ? $users->phone_number : old('pnumber') }}">
                                    </div>
